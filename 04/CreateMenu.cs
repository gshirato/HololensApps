...
public class CreateMenu : MonoBehaviour
{
    ...
    IEnumerator ReadFile(int i)
    {
        ...
        //Renderer
        __file = Path.GetFileNameWithoutExtension(jsonclass.DataStructure[(int)JsonClass.dataKeys.id + i * 4]);
        
        __name = jsonclass.images[i];
        __path = global.appPath + "Data/" + __file + "/" + __name;
        ...
        else
        {
            ...
            print(www.url + " has an error " + www.error);
        }
    ...
    void SetPlane(int i)
    {
        ...
        //name 
        planeObjects[i].name = jsonclass.DataStructure[(int)JsonClass.dataKeys.id + i * 4];
